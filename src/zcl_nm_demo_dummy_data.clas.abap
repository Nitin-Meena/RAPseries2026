CLASS zcl_nm_demo_dummy_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      c_error                     TYPE znm_dmo_position-price VALUE '37707',
  ...
  PRIVATE SECTION.
    DATA:
      mt_partner         TYPE STANDARD TABLE OF znm_dmo_partner,
      mt_material        TYPE STANDARD TABLE OF znm_dmo_material,
      mt_discount        TYPE STANDARD TABLE OF znm_dmo_discount,
      mt_head            TYPE STANDARD TABLE OF znm_dmo_invoice,
      mt_position        TYPE STANDARD TABLE OF znm_dmo_position,
    ...
    METHODS:
      ...
      create_head
        RETURNING
          VALUE(rs_result) TYPE znm_dmo_invoice,

      create_positions
        IMPORTING
          is_head TYPE znm_dmo_invoice.
ENDCLASS.



CLASS ZCL_NM_DEMO_DUMMY_DATA IMPLEMENTATION.
  ...
  METHOD create_discount.
    ...
    DELETE FROM znm_dmo_discount.
    INSERT znm_dmo_discount FROM TABLE @mt_discount.
  ENDMETHOD.
  ...
  METHOD create_invoice.
    ...
    DELETE FROM znm_dmo_invoice.
    INSERT znm_dmo_invoice FROM TABLE @mt_head.
    DELETE FROM znm_dmo_position.
    INSERT znm_dmo_position FROM TABLE @mt_position.
  ENDMETHOD.
  ...
  METHOD create_material.
    ...
    DELETE FROM znm_dmo_material.
    INSERT znm_dmo_material FROM TABLE @mt_material.
  ENDMETHOD.
  ...
  METHOD create_partner.
    ...
    DELETE FROM znm_dmo_partner.
    INSERT znm_dmo_partner FROM TABLE @mt_partner.
  ENDMETHOD.
  ...
  METHOD create_positions.
    ...
    DO mo_random_position->rand( ) TIMES.
      ...
      DATA(ls_position) = VALUE znm_dmo_position(
      ...
      TRY.
          SELECT SINGLE FROM znm_dmo_discount
            FIELDS
              currency_conversion(
